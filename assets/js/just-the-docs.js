...
function initSearch() {
  ...
  request.open('GET', 'https://developers.basistheory.com/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://developers.basistheory.com/assets/css/just-the-docs-' + theme + '.css');
}
