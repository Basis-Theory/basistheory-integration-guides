...
This example only supports tokenizing data today, and will soon enable you to also use our Reactor platform in a safe and secure manner without Basis Theory having ongoing access to your data. If you'd like to use our Reactors with your own encryption, [we'd love to chat.](https://community.basistheory.com)
