...
<span class="base-alert warning">
    <span>
    To run a Reactor, an Application needs `token:use` permission granted for any tokens that are detokenized. 
    <a href="https://portal.basistheory.com/applications/create?application_template_id=31efed55-035c-4b49-b1a1-609a728d91ce" target="_blank">Click here to create one.</a>
    </span>
</span>
